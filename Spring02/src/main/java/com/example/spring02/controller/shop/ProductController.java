...
//  /edit/32 => 상품코드가 PathVariable에 저장됨	
	...
	public String delete(@RequestParam int product_id) {
		...
		if(filename != null && !filename.equals("-")) {
			String path="C:\\Users\\jiyeon\\Documents\\workspace-spring-tool-suite-4-4.2.2.RELEASE"
					+ "\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps"
					+ "\\Spring02\\webapp\\WEB-INF\\views\\images\\"; //상품이미지 디렉토리
	...
	public String update(ProductDTO dto) {
		...
		if(!dto.getFile1().isEmpty()) {
			...
			try {
				String path="C:\\Users\\jiyeon\\Documents\\workspace-spring-tool-suite-4-4.2.2.RELEASE"
						+ "\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps"
						+ "\\Spring02\\webapp\\WEB-INF\\views\\images\\";						
				//디렉토리가 존재하지 않으면 생성
				new File(path).mkdir();
...
//배포디렉터리	
//C:\Users\jiyeon\Documents\workspace-spring-tool-suite-4-4.2.2.RELEASE\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\Spring02\ 
