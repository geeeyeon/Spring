...
public class PDSBoardTests {
	...
	//@Modifying과 @Query를 이용한 수정
	@Transactional
	@Test
	public void testUpdateFileName1() {	  
		Long fno = 1L; String newName = "updatedFile1.doc";	  
	...
	public void testUpdateFileName2() {
		...
		result.ifPresent(pds->{log.info("데이터가 존재하므로 update시도");
	...
	//조인처리(특정 자료의 번호와 자료의 제목, 첨부파일의 수를 같이 보여주는 상황)
	@Test
